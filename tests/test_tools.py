...
class TestServerTools(unittest.TestCase):
    def test_chunk_bytes(self) -> None:
        data = b"abcdefghij"
        chunks = yashserver.ServerTools.chunk_bytes(data, 3)
    ...
    def test_retry_sync(self) -> None:
        ...
        value = yashserver.ServerTools.retry(flaky, attempts=3, delay_seconds=0.0)
    ...
    def test_retry_async(self) -> None:
        ...
        async def run_test() -> str:
            return await yashserver.ServerTools.retry_async(flaky_async, attempts=2, delay_seconds=0.0)
